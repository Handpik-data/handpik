    ...
    async def scrape_pdp(self, product_link):
        ...
        try:
            ...
            try:
                ...
                price_span = None  # Initialize outside so it's accessible later
                ...
                return {'error': f'Exception occurred while extracting prices or currency: {str(e)}', 'product_link': product_link}
