    ...
    async def scrape_products_links(self, url):
        ...
        while True:
            try:
                ...
                # Updated selector according to provided tag
                product_links = soup.select('a.sr4-full-width-link.is--href-replaced')
                ...
                # Pagination: look for next page link (update selector if needed)
